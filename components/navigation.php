<div class="relative">
    <nav class="flex bg-black opacity-100 h-28 items-center justify-between text-white relative z-10">
        <div class="flex items-center mx-auto" style="transform: translateX(10%);">
            ...
            <div class="nav-item mx-4"><a href="<?= ROOT_DIR ?>contact">BLOG</a></div>
